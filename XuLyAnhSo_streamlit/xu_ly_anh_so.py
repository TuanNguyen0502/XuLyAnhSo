...
class App(tk.Tk):
    def	__init__(self):
        ...
        self.imgout = None
        self.filename = None
        self.model = YOLO('yolov8n_trai_cay.onnx', task='detect')
        ...
        chapter5_menu = tk.Menu(menu, tearoff=0)
        chapter5_menu.add_command(label="Create Motion", command=self.mnu_c5_create_motion_click)
        menu.add_cascade(label="Chapter5", menu=chapter5_menu)
